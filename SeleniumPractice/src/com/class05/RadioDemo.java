...
//		System.out.println(maleRadio.isDisplayed());// trues
...
//		System.out.println(maleRadio.isSelected());// true
		...
		Iterator<WebElement> it = professionList.iterator();
		
		while(it.hasNext()) {
			WebElement profession = it.next();
			if (profession.isEnabled()) {
				String id = profession.getAttribute("id");
				System.out.println(id);
				
				if (id.equals("profession-0")) {
					profession.click();
				}
